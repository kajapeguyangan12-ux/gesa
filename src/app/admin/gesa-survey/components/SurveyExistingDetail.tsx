...
export default function SurveyExistingDetail({
  ...
  const handleExportExcel = () => {
    ...
    link.href = url;
    link.download = `survey-existing-${new Date().toISOString().split('T')[0]}.csv`;
    link.click();
  };
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl shadow-xl p-6 text-white">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold">Survey Existing</h1>
              <p className="text-blue-100 text-sm mt-1">
                Data Survey Existing yang telah {statusFilter === "tervalidasi" ? "tervalidasi" : statusFilter}
              </p>
            </div>
          </div>
          <button 
            onClick={handleExportExcel}
            className="flex items-center gap-2 px-5 py-2.5 bg-white text-blue-700 font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 hover:bg-blue-50"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-4 border border-gray-100">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <select
            ...
            className="px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white min-w-[150px]"
          >
          ...
          <div className="flex items-center gap-2 px-4 py-2.5 bg-blue-50 rounded-xl border border-blue-100">
            ...
            <span className="text-blue-600 text-sm">dari {surveys.length} data</span>
          </div>
        </div>
      </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-gray-500 text-center max-w-md">
              Belum ada data Survey Existing yang sesuai dengan filter.
            </p>
          </div>
        ) : (
          <>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  <div className="text-sm text-gray-600">
                    <span>Menampilkan {paginatedSurveys.length} dari {totalItems > 0 ? effectiveTotalItems : "?"} data</span>
                  </div>
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          ...
          <div className="flex items-center justify-center min-h-screen p-4">
            <div className="relative bg-white rounded-3xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto">
              {/* Modal Header */}
              <div className="sticky top-0 z-10 bg-gradient-to-r from-blue-600 to-indigo-700 text-white p-6 rounded-t-3xl">
                <div className="flex items-center justify-between">
                  <div>
                    <h2 className="text-2xl font-bold">Detail Survey Existing</h2>
                    <p className="text-blue-100 text-sm mt-1">{selectedSurvey.title}</p>
                  </div>
                  <button
                    onClick={() => {
                      closeDetailModal();
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-4 border border-gray-200">
                  ...
                  {!showDetailMap ? (
                    <div className="rounded-xl border border-dashed border-blue-200 bg-white px-4 py-6 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-blue-50 rounded-2xl p-5 border border-blue-100">
                    ...
                    <div className="space-y-3">
                      ...
                      <InfoRow label="Nama Gang" value={selectedSurvey.namaGang || "N/A"} />
                      <InfoRow label="Lokasi Jalan" value={selectedSurvey.lokasiJalan || "N/A"} />
                ...
                <div className="bg-purple-50 rounded-2xl p-5 border border-purple-100">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    <InfoCard label="Jenis Existing" value={selectedSurvey.jenisExisting} />
                    <InfoCard label="Jenis Titik" value={selectedSurvey.jenisTitik || selectedSurvey.jenis} />
                    <InfoCard label="Kepemilikan" value={selectedSurvey.kepemilikan} />
                    <InfoCard label="Keterangan Tiang" value={selectedSurvey.keteranganTiang} />
                    <InfoCard label="Tinggi APM" value={selectedSurvey.tinggiAPM} />
                    <InfoCard label="Tinggi ARM" value={selectedSurvey.tinggiArm || selectedSurvey.tinggiARM} />
                    <InfoCard label="Palet" value={selectedSurvey.palet} />
                    <InfoCard label="Lumina" value={selectedSurvey.lumina} />
                    <InfoCard label="Metode Ukur" value={selectedSurvey.metodeUkur} />
                ...
                <div className="bg-teal-50 rounded-2xl p-5 border border-teal-100">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    <InfoCard label="Tinggi Median" value={selectedSurvey.tinggiMedian} />
                    <InfoCard label="Lebar Median" value={selectedSurvey.lebarMedian} />
                    <InfoCard label="Lebar Jalan 1" value={selectedSurvey.lebarJalan1} />
                    <InfoCard label="Lebar Jalan 2" value={selectedSurvey.lebarJalan2} />
                    <InfoCard label="Lebar Trotoar" value={selectedSurvey.lebarTrotoar} />
                    <InfoCard label="Lampu Berdekatan" value={selectedSurvey.lamnyaBerdekatan} />
                    <InfoCard label="Lebar Bahu Bertiang" value={selectedSurvey.lebarBahuBertiang} />
                    <InfoCard label="Lebar Trotoar Bertiang" value={selectedSurvey.lebarTrotoarBertiang} />
                  </div>
                </div>
