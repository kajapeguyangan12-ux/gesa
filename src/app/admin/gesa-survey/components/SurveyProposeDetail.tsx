...
export default function SurveyProposeDetail({ onBack, statusFilter = "tervalidasi" }: SurveyProposeDetailProps) {
  ...
  const fetchSurveys = async () => {
    try {
      ...
      // Query untuk Survey APJ Propose berdasarkan statusFilter
  ...
  const handleExportExcel = () => {
    console.log("Exporting Survey APJ Propose to Excel...");
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Survey Tiang APJ Propose</h1>
              <p className="text-sm text-gray-600 mt-1">Data Survey Tiang APJ Propose yang telah tervalidasi</p>
            </div>
          </div>
          <button 
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-sm text-gray-600 text-center max-w-md">
              Belum ada data Survey Tiang APJ Propose yang telah tervalidasi.
            </p>
          </div>
        ) : (
