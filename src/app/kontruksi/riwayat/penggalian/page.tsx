...
function RiwayatPenggalianPanelContent() {
    ...
    () => [
      {
        id: "penggalian",
        title: "Penggalian",
        route: "/kontruksi/riwayat/penggalian/penggalian",
        icon: (
      ...
      },
      {
        ...
        route: "/kontruksi/riwayat/penggalian/pembesian",
        icon: (
          <svg className="w-12 h-12 text-gray-900" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6}>
      ...
      },
      {
        id: "pengecoran",
        title: "Pengecoran",
        route: "/kontruksi/riwayat/penggalian/pengecoran",
        icon: (
          <svg className="w-12 h-12 text-gray-900" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6}>
      ...
      },
      {
        id: "uji-beton",
        title: "Uji Beton",
        route: "/kontruksi/riwayat/penggalian/uji-beton",
        icon: (
          <svg className="w-12 h-12 text-gray-900" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6}>
    ...
    <div className="relative min-h-screen bg-white overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-md px-5 pb-24 pt-5">
        ...
        <header className="mt-2 flex items-center justify-between">
          <button
            onClick={() => router.push("/kontruksi/riwayat")}
...
export default function RiwayatPenggalianPanelPage() {
  return (
    <ProtectedRoute>
      <RiwayatPenggalianPanelContent />
    </ProtectedRoute>
  );
}
