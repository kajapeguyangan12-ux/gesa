...
function RiwayatKontruksiContent() {
    ...
    () => [
      {
        ...
        route: "/kontruksi/riwayat/penggalian",
        icon: (
      ...
      },
      {
        ...
        route: "/kontruksi/riwayat/pemasangan-tiang",
        icon: (
          <svg className="w-12 h-12 text-gray-900" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6}>
      ...
      },
      {
        ...
        route: "/kontruksi/riwayat/pemasangan-kabel",
        icon: (
          <svg className="w-12 h-12 text-gray-900" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6}>
      ...
      },
      {
        id: "comissioning",
        title: "Comissioning",
        route: "/kontruksi/riwayat/comissioning",
        icon: (
          <svg className="w-12 h-12 text-gray-900" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6}>
      ...
      <div className="relative mx-auto w-full max-w-md px-5 pb-24 pt-5">
        ...
        <header className="mt-2 flex items-center justify-between">
          ...
          <div className="text-center">
            <div className="text-base font-semibold text-gray-900">Riwayat Kontruksi</div>
          </div>
...
export default function RiwayatKontruksiPage() {
  return (
    <ProtectedRoute>
      <RiwayatKontruksiContent />
    </ProtectedRoute>
  );
}
