...
function FormPenggalianContent() {
      ...
      <div className="relative mx-auto w-full max-w-md px-5 pb-24 pt-5">
        ...
        <header className="mt-2 flex items-center justify-between">
          ...
          <div className="text-center">
            <div className="text-base font-semibold text-gray-900">Form Penggalian</div>
          </div>
        ...
        <div className="mt-6 rounded-2xl border border-gray-300 bg-white p-4 shadow-sm">
          ...
          <div className="mt-4 space-y-3">
            ...
            <div>
              <label className="text-[11px] font-semibold text-gray-900">Kedalaman Galian</label>
              <input
                type="text"
                placeholder="Masukkan Kedalaman Galian"
                className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 text-xs"
              />
            </div>

            <div>
              <label className="text-[11px] font-semibold text-gray-900">Foto Kedalaman</label>
              <div className="mt-1 flex items-center gap-2 rounded-lg border border-gray-300 px-3 py-2 text-xs">
                <input type="text" placeholder="Masukkan Foto Kedalaman" className="w-full outline-none" />
