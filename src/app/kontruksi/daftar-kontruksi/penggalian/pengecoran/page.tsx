...
function FormPengecoranContent() {
      ...
      <div className="relative mx-auto w-full max-w-md px-5 pb-24 pt-5">
        ...
        <header className="mt-2 flex items-center justify-between">
          ...
          <div className="text-center">
            <div className="text-base font-semibold text-gray-900">Pengecoran</div>
          </div>
        ...
        <div className="mt-6 rounded-2xl border border-gray-300 bg-white p-4 shadow-sm">
          ...
          <div className="mt-4 space-y-3">
            ...
            <div>
              <label className="text-[11px] font-semibold text-gray-900">Foto Uji Slump Test</label>
              <div className="mt-1 flex items-center gap-2 rounded-lg border border-gray-300 px-3 py-2 text-xs">
                <input type="text" placeholder="Masukkan Foto Uji Slump Test" className="w-full outline-none" />
            ...
            <div>
              <label className="text-[11px] font-semibold text-gray-900">Foto Hasil Pengecoran</label>
              <div className="mt-1 flex items-center gap-2 rounded-lg border border-gray-300 px-3 py-2 text-xs">
                <input type="text" placeholder="Masukkan Foto Hasil Pengecoran" className="w-full outline-none" />
                <svg className="w-4 h-4 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8h3l2-3h8l2 3h3v11H3z" />
                  <circle cx="12" cy="13" r="3" />
                </svg>
