                ...
                {selectedTask.status === "in-progress" && (
                  <>
                    ...
                    <button
                      ...
                      className="mt-3 flex-1 rounded-xl bg-emerald-600 px-4 py-3 text-sm font-semibold text-white transition hover:bg-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed sm:mt-0 flex items-center justify-center gap-2"
                    >
                      {completingTask ? (
                        <>
